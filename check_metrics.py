...
def главное():
    ...
    print('\n  ВНИМАНИЕ: ПЕРВОЕ число — НЕ РАВНО ДОЛГУ: в его выводе есть')
    print('  законные строки (раскладка экземпляра), читать по таблице')
    print('  в §6.0.2. У пятого законных строк с 2026-08-20 НЕТ — обе')

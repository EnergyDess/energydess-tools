...
Проекты с LLM. Если вакансия связана с промпт-инженерией, LLM-интеграциями, AI-workflow, разработкой AI-агентов — при описании проектов из досье раскрывай конкретные LLM-компоненты (двухэтапные пайплайны, промпт-конструкторы, JSON-схемы, интеграции через OpenRouter/API). Не описывай проект общими словами («SaaS-хаб», «лендинг») — раскрывай именно те аспекты, которые доказывают релевантность вакансии.

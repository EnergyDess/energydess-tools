...
async def _апт_найти_дозы(поз):
    ...
    for источник in _апт_ист.ПОРЯДОК:
        # ТАЙМАУТ — СВОЙСТВО ИСТОЧНИКА, поэтому и клиент свой.
        # Замер: карточка Видаля приходит за 1–2 с, карточка wer.ru
        # за 4.8–13.9 с, и общий потолок резал бы второй на обычной
        # странице — а выглядело бы это как «источник ничего не знает»

...
Что писать:
- Одним предложением — почему именно эта вакансия, не другая. Конкретно, не "я давно мечтал".
- 2–3 факта из опыта, которые напрямую закрывают требования вакансии. Цифры, проекты, результаты — не прилагательные.
- Если есть портфолио/ссылки в резюме — вставь в конце.
...
- Любое повторение того, что уже сказано выше
- ИИ-зачины: "Конечно!", "Безусловно", "Рад помочь", "Вот письмо:"
- Вступительные абзацы-пустышки типа "Ознакомившись с вакансией, я понял что..."

...
даты регистрации и последней смены пароля.</p>

<h3>HH-ассистент</h3>
<p>Текст резюме, который вы загрузили. Профессиональное досье: должность,
город, формат работы, языки, опыт по компаниям с периодами, проекты, навыки,
предпочтения по тону писем.</p>

<p>По каждому письму: полный текст вакансии, сгенерированное письмо, разбор
требований, название компании и должности.</p>

<h3>Дневник питания</h3>
<p>Пол, возраст, рост, вес, цель, уровень активности. Записи о съеденном
по датам с калорийностью и составом, вода, добавленные вами продукты
и рецепты.</p>
...
о пропусках, каждый подход с весом и числом повторений.</p>
...
ни для анализа, ни для распознавания.</strong> Фото тела хранятся в базе,
поэтому попадают в её ежедневную резервную копию — зашифрованную, но всё
же уходящую за пределы сервера. Аватар лежит отдельным файлом и в копию
не входит.</p>
</div>
...
<table class="doc-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td data-label="Что передаётся">текст вакансии, резюме, досье, переписка с ассистентами, рацион, измерения тела, зоны боли, программа тренировок, фотографии еды</td>
      <td data-label="Где находится">США</td>
    </tr>
    <tr>
...
<p>Автор проекта имеет доступ к базе — это неизбежно, поскольку он же её
и обслуживает. На практике в служебном интерфейсе отображается:</p>
<ul>

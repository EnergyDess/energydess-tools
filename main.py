...
8. ЕСЛИ В ВОПРОСЕ ЕСТЬ ХОТЬ ОДНО ИЗ ЭТОГО — {стоп} — не ищи ничего вовсе: поставь тип "иное", оставь «подходят» пустым, а в «нет» скажи, что это повод обратиться к врачу, а не искать таблетку дома."""
...
АПТ_ХВОСТ_СТОП = ("(программа остановила разговор сама: %s. "
                  "Эту фразу писала не ты — повторять её не надо)")

...
#
# ЧИСЛО ВЫВЕДЕНО ЗАМЕРОМ, А НЕ НАЗНАЧЕНО. `/proc/<pid>/status`
# на проде сразу после перезапуска, кеш пуст: uvicorn 110 МБ,
# hallpass 21 МБ, init 5 МБ при MemTotal 212 МБ. Свободно 76 МБ,
# и из них кешу отдаётся 24 — остальное запас на пик разбора
# (замерен: 1.86 МБ на страницу), на отрисовку и на разбор фото.
#
...
REF_CACHE_MB = float(os.getenv("MEDKIT_REF_CACHE_MB", "24"))

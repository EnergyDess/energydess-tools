...
STATIC_PAGES = {
    "about": {
        "title": "О проекте",
        "desc": "Что такое EnergyDess и зачем он нужен.",
        "lead": "Личный хаб AI-инструментов: что здесь есть и как этим пользоваться.",
        "content": None,
    },
    "me": {
        "title": "Обо мне",
        "desc": "Кто делает EnergyDess.",
        "lead": "Кто я и почему собираю эти инструменты сам.",
        "content": None,
    },
    "terms": {
        "title": "Правила сайта",
        "desc": "Условия использования EnergyDess.",
        "lead": "Что можно и чего нельзя при использовании сайта.",
        "content": None,
    },
    "privacy": {
        "title": "Политика конфиденциальности",
        "desc": "Какие данные собирает EnergyDess и что с ними происходит.",
        "lead": "Какие данные сайт хранит, зачем и как их удалить.",
        "content": None,
    },
    "cookies": {
        "title": "Cookies",
...
<h2>Вопросы</h2>
<p>Пишите на <a href="mailto:denison7111@gmail.com">denison7111@gmail.com</a>.</p>
""",
    },
}

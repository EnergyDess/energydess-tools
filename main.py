...
def _апт_наружу(поз, сегодня, места_по_id, кат_по_позиции):
    ...
    return {
        ...
        "искать": " ".join(x for x in (поз.name, поз.substance or "",
                                       форма.get("имя", ""),
                                       поз.note or "",
                                       поз.code_gtin or "") if x).lower(),
    }
...
def _апт_данные(db, user):
    ...
    наружу = [_апт_наружу(п, сегодня, места_по_id, кат_по_позиции)
              for п in позиции]

...
TOOLS = [
    {
        ...
        "color": "purple",
        "url": "/hh",
        "desc": "Вставьте ссылку на вакансию или её текст — за 30 секунд получите готовое сопроводительное письмо под ваше резюме и конкретные требования работодателя.",
        "active": True,
    },
    {
        "id": "enshrouded",

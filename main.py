...
def _апт_промпт_запроса(вопрос: str, позиции, кат_имена) -> tuple[str, int]:
...
async def _апт_ответ_на_запрос(вопрос: str, db, user) -> dict:
    ...
    return {"вид": "запрос", "вступление": вступление, "нашлось": нашлось,
...
async def medkit_assist(request: Request,
    ...
    if вид.startswith("multipart/"):
        ...
        if стоп:
            ...
            return JSONResponse({"вид": "стоп", "повод": стоп,
